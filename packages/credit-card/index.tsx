...
export const CreditCard = ({ className, ...props }: CreditCardProps) => (
  <div
    className={cn(
      'group/pal-ui-credit-card perspective-distant aspect-[8560/5398] w-full max-w-96 text-white',
      '@container',
      className
    )}
    {...props}
    ...
    <CreditCardFlipContext.Provider value={true}>
      ...
      <div
        ...
        className={cn(
          ...
          supportsHover &&
          'group-hover/pal-ui-credit-card:-rotate-y-180 group-hover/pal-ui-credit-card:shadow-lg',
...
export const CreditCardChip = ({
  ...
  children ? (
    ...
    >
      <title>Chip</title>
      <path
        fill="url(#pal-ui-credit-card-chip-gradient)"
      ...
      <defs>
        <linearGradient
          id="pal-ui-credit-card-chip-gradient"
          x1="1"
          x2="112.7"
          y1="46"
          y2="78.12"
