...
import palUi from '@/public/logomark.svg';
...
export const Installer = ({ packageName }: InstallerProps) => {
  const [value, setValue] = useState('pal-ui');


  const commands = {
    'pal-ui': {
      image: palUi,
      code: `npx pal-ui@latest add ${packageName}`,
    },
    shadcn: {
      image: shadcn,
      code: `npx shadcn@latest add https://pal-ui.beamitpal.com/registry/${packageName}.json`,
    },
  };
